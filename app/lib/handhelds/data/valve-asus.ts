    ...
    configurations: [
      {
        ...
        priceUsd: 789,
        priceNote: 'Current MSRP (launched at $399 in 2022; Valve reset pricing at OLED launch)',
      },
      {
        id: 'SD-LCD-512',
        label: '512 GB LCD',
    ...
    configurations: [
      {
        ...
        storage: '512 GB NVMe SSD (M.2 2230, user-replaceable)',
        priceUsd: 949,
        priceNote: 'Current MSRP (launched at $549)',
      },
      {
        id: 'SD-OLED-1TB',
        label: '1 TB OLED',
        ...
        priceUsd: 1049,
        priceNote: 'Current MSRP (launched at $649)',
