...
export type GetLatestPostsQueryQueryVariables = Exact<{ [key: string]: never }>;

export type GetLatestPostsQueryQuery = {
  __typename?: 'RootQuery';
  posts?: {
    __typename?: 'RootQueryToPostConnection';
    nodes: Array<{
...
export const GetLatestPostsQueryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetLatestPostsQuery' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
  ...
  GetLatestPostsQueryQuery,
  GetLatestPostsQueryQueryVariables
>;
